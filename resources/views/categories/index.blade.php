	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
					...
					{!! Form::text('q', isset($q) ? $q : null, ['class'=>'form-control', 'placeholder' => 'Cari category..']) !!}
					{!! $errors->first('q', '<p class="help-block">:message</p>') !!}
					</div>
					{!! Form::submit('Cari Menu', ['class'=>'button-solid-sm']) !!}
					{!! Form::close() !!}
					<table class="table table-hover">
						<thead>
							<tr>
								<td style="font-weight: 500; font-size: 20px;">Title</td>
								<td style="font-weight: 500; font-size: 20px;">Parent</td>
							</tr>
						</thead>
						<tbody>
